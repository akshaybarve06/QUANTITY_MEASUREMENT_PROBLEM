...
describe('Testing for Length Check', function ()
{
    ...
    {
        assert.equal(true, lengthCheck.checkLengthOfUnits(0, 0))
    })
    ...
    {
        assert.notEqual(lengthCheck.returnSame(1),lengthCheck.yardToInch(1))
    })
    ...
    {
        assert.equal(lengthCheck.yardToInch(1), lengthCheck.returnSame(36))
    })
    ...
    {
        assert.equal(lengthCheck.returnSame(36), lengthCheck.yardToInch(1))
    })
    ...
    {
        assert.equal(lengthCheck.returnSame(2),lengthCheck.cmsToInch(5))
    })
})
